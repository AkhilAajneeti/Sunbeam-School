...
export const story = {
  ...
  paragraphs: [
    /* ⚠ BOTH FOUNDERS NAMED — see the note on `founders` in data/site.ts. This
       sentence is the homepage's copy of the same fact and was corrected with
       it; the two must not disagree. */
    'Sunbeam began in Varanasi in 1972, founded by Dr. Amrit Lal ‘Ishrat’ Madhok and Mrs. Deesh ‘Ishrat’ Madhok on a conviction that the schools around them were not meeting the whole of a child’s needs.',
  ...
  links: [
    /* ⚠ RENAMED TO "Our Journey" WITH THE PAGE — see data/navigation.ts. The
       href is unchanged on purpose. */
