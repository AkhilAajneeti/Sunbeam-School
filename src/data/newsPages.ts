  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        photoDir: 'District-Junior-Volleyball',
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        photoDir: 'Teacher_s Day',
        /* ⚠ ONE FRAME HELD BACK, AND ONLY FROM THE CARD FACE'S POINT OF VIEW.
           DSC_0718 is the students' opening performance; it sorts first, so it
           would have become the face of an item whose whole subject is the
           STAFF being thanked — the same fault the QCT/CIC skip exists for. The
           other twenty-eight frames are the felicitation itself. The picture is
           not deleted: it belongs to the student-led programme above, and this
           line undoes the moment the school files it there. */
        photoSkip: ['DSC_0718'],
